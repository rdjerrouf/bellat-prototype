...
// Define the props for the page, which include the dynamic route parameter `id`.
    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            <h1 className="text-3xl font-bold">{product.name_fr}</h1>
            ...
            <div className="mt-4">
              <Badge variant={product.stock_status === 'in_stock' ? 'success' : 'warning'}>
                {product.stock_status === 'in_stock' ? 'En stock' : 'Stock faible'}
              </Badge>
            </div>

            <div className="mt-6 border-t pt-6">
              <h2 className="font-semibold">Description</h2>
              <p className="mt-2 text-gray-600">{product.description_fr}</p>
            </div>

            {/* This is a Client Component for handling user interactions like
                changing quantity and adding the product to the cart. */}
